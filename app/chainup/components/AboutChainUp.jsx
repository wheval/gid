...
const AboutChainUp = () => {
  return (
    <div className="flex flex-col space-between p-10 lg:p-20 md:flex-row bg-[#FAB622]">
      <h2 className="font-[550] text-center  text-5xl block md:hidden">
        Chain Up
      </h2>
      ...
      >
        <h2 className="font-[550] text-center text-4xl  hidden md:block">
          Chain Up
        </h2>
        <div className="font-lato">
          <p>
            The GIDA Chain-Up Roadshows are a series of blockchain-focused
            events aimed at educating, engaging and empowering blockchain
            enthusiasts across 5 cities in Nigeria - Kaduna, Ibadan, Benin City,
            Anambra and Enugu.
          </p>
          <br />
          ...
          <p>
            ...
            enthusiasts and like-minded individuals, and we would provide you
            with a scholarship opportunity to learn the skill of Blockchain/Web3
          ...
          <p>
            ...
            Whether you’re just starting out on your blockchain journey, Into
            the ecosystem already or a Pro, you’re welcome!
          </p>
        </div>
