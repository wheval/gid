...
return (
    <div className="px-4 sm:px-8 py-8 sm:py-16 text-white bg-[#A20812]">
            <div className="max-w-screen-2xl mx-auto flex flex-col gap-10 sm:gap-20 mb-10 sm:mb-20 items-center justify-center">
                    <div className="text-center">
                        ...
                        <div className="relative scale-90 sm:scale-100">
                            <div className="w-full shadow-sm max-w-full lg:max-w-[1050px] lg:w-[1050px] rounded-[28px] relative z-30 overflow-hidden flex flex-col items-center justify-center">
                                    ...
                                    <div className="flex flex-col sm:flex-row justify-between gap-4 sm:gap-12 bg-white text-black px-4 py-3 lg:mt-4 lg:px-4 lg:py-4 min-w-full">
                                            <div className="m-0 p-0 flex flex-col gap-1 lg:gap-4">
                                                    ...
                                                    <p className="text-sm sm:text-[1.275rem] sm:w-[45ch] tracking-tight leading-snug text-black/60 font-lato">
                                            ...
                                            <div className="flex flex-col gap-2 justify-between min-h-full">
                                                    <div className="flex items-center justify-between gap-2 lg:gap-x-12 w-full">
                                                            <div className="flex flex-col justify-between lg:gap-y-6">
                                                                    <p className="font-lato text-sm sm:text-[1.25rem] text-gray-500">Mission</p>
                                                                    <p className="font-bold font-[family-name:var(--font-abhaya-libre)] text-2xl sm:text-[3.175rem]">1</p>
                                                            </div>
                                                            <div className="flex flex-col justify-between lg:gap-y-6">
                                                                    <p className="font-lato text-sm sm:text-[1.25rem] text-gray-500">Cities</p>
                                                                    <p className="font-bold font-[family-name:var(--font-abhaya-libre)] text-2xl sm:text-[3.175rem]">5</p>
                                                            </div>
                                                            <div className="flex flex-col justify-between lg:gap-y-6">
                                                                    <p className="font-lato text-sm sm:text-[1.25rem] text-gray-500">Attendees</p>
                                                                    <p className="font-bold font-[family-name:var(--font-abhaya-libre)] text-2xl sm:text-[3.175rem]">500+</p>
                                                            </div>
                                                    </div>
                            ...
                            <div className="absolute bg-[#F8F8F8] w-full h-[88%] shadow-sm sm:w-[100%] sm:h-[85%] z-20 rounded-[10px] top-[18%] left-[-3%]"></div>
                            <div className="absolute bg-[#EDEDED] w-full h-[84%] shadow-sm sm:w-[97%] sm:h-[80%] z-10 rounded-[15px] top-[28%] left-[-6%]"></div>
                            <div className="absolute bg-[#FFFFFF] hidden sm:block shadow-sm w-full h-[70%] sm:w-[95%] sm:h-[76%] z-0 rounded-[15px] top-[38%] left-[-9%]"></div>
                        </div>
            </div>
    </div>
)
