...
const HeroSection = () => {
return (
    <div className='w-full min-h-[95vh] h-[95vh] flex flex-col justify-center items-center text-center text-white bg-[url("/assets/homepage_hero_bg.svg")] bg-cover bg-center bg-no-repeat'>
