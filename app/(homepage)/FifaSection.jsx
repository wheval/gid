...
const FifaSection = () => {
return (
    <div className="px-8 py-12 lg:px-24 lg:py-[200px] bg-accent h-[100%] bg-[url('/assets/box_yellow.svg')] flex flex-col items-center justify-center bg-no-repeat bg-cover">
