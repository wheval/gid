...
const Activities = () => {
  return (
    <div className="flex flex-col md:flex-row items-center md:items-start gap-8 p-16">
      {/* Text Content */}
      <div className="flex items-center h-screen md:w-1/2">
        <div className=''>
          <h1 className="text-5xl font-semibold mb-8 pr-10">
      ...
      <div className=" h-screen w-full md:w-1/2 relative">
        <img src="/assets/leftarrow.png" className='absolute w-14 -left-8 top-1/3 z-50' alt="" />
        {/* First Image */}
        ...
        {/* Second Image */}
        <div className="absolute w-96 h-96 left-56 top-16 z-20">
          <img
        ...
        <img src="/assets/rightarrow.png" className='absolute w-14 -right-1 top-1/3 z-50' alt="" />
      </div>
    </div>
  );
};
