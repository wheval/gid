  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://api.gida.academy/events/chain-up-roadshow-ibadan/register",
        {
          method: "POST",
          body: jsonData,
          headers: {
    ...
    <main className=" text-white relative min-h-screen pb-4">
      ...
      {success && (
        <RegisterSuccess
          ...
          whatsapp={"https://chat.whatsapp.com/FMTEu0QCfHuBybXC6xTjWx"}
          eventText={'Chain Up Ibadan Roadshow'}
        />
      )}
      {errorMsg && (
