  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://api.gida.academy/events/chain-up-roadshow-benin/register",
        {
          method: "POST",
          body: jsonData,
          headers: {
    ...
    <main className=" text-white relative min-h-screen pb-4">
      ...
      {success && (
        <RegisterSuccess
          ...
          whatsapp={"https://chat.whatsapp.com/J4JWQ0Lw6JKGFz6Np8cY1D"}
          eventText={'Chain Up Benin Roadshow'}
        />
      )}
      {errorMsg && (
